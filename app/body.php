...
<div class="col-xs-6 col-sm-4 col-md-3 col-lg-12">
	...
	<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3 text-center botonsitos" style="">
		    ...
		    <input type="submit" name="Submit37" value="Finanzas" class="mibotonsito"  style="background:white url('FINANZAS.jpg');background-size: 65px 65px;background-repeat:no-repeat; background-position:50% 0px; " onClick="window.open('r2d2_1/finanzas/index.php','_blank')">
		...
		<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3 text-center botonsitos" style="">
		    ...
		    <input type="submit" name="Submit36" value="Tracker tiempo" class="mibotonsito"  style="background:white url('11371551-cronometro-sobre-fondo-blanco-aislados-imagen-en-3d.jpg');background-size: 55px 55px;background-repeat:no-repeat; background-position:50% 4px; " onClick="window.open('r2d2_1/tracker/index.php','_blank')">
		...
		<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3 text-center botonsitos" style="">
                         ...
                         <input type="button" name="Submit38" value="Mis tareas" class="mibotonsito"  style="background:white  url('task.png');background-size: 48px 48px;background-repeat:no-repeat; background-position:50% 7px; " onClick="window.open('r2d2_1/tareas/3.php','_blank')">
